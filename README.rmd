...
The purpose of this __R__ package is to facilitate maintenance of a database of books, such as those used for courses within a university department.
...
Next, initialize the google sheet to manage the booklist using your google drive account. __You should only have to do this once__.
